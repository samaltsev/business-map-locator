...
final class SchemaMigrator {
    ...
    public function migrate(): bool {
        ...
        $steps=[1=>static fn()=>dbDelta(\BML_Schema::locations_index_sql()),2=>static fn()=>dbDelta(\BML_Schema::import_jobs_sql()),3=>static fn()=>dbDelta(\BML_Schema::import_job_rows_sql()),4=>static fn()=>dbDelta(\BML_Schema::import_job_events_sql()),5=>static fn()=>dbDelta(\BML_Schema::location_terms_sql())];
