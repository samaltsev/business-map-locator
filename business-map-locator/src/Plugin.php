...
final class Plugin
{
    ...
    private function registerServices(): void
    {
        ...
        $this->container->set(\BusinessMapLocator\Admin\Location\LocationWriteService::class, static fn (Container $c): \BusinessMapLocator\Admin\Location\LocationWriteService => new \BusinessMapLocator\Admin\Location\LocationWriteService($c->get(\BML_Location_Index::class)));
        $this->container->set(\BusinessMapLocator\Admin\Ajax\LocationEditorAjaxController::class, static fn (Container $c): \BusinessMapLocator\Admin\Ajax\LocationEditorAjaxController => new \BusinessMapLocator\Admin\Ajax\LocationEditorAjaxController($c->get(\BusinessMapLocator\Admin\Location\LocationWriteService::class)));
        ...
        $this->container->set(\BusinessMapLocator\Admin\Migration\MigrationControlPage::class, static fn (Container $c): \BusinessMapLocator\Admin\Migration\MigrationControlPage => new \BusinessMapLocator\Admin\Migration\MigrationControlPage($c->get(\BusinessMapLocator\Admin\Shared\AdminShell::class), $c->get(AreaMigrationService::class), $c->get(AreaMigrationStateStore::class), $c->get(AreaMigrationExecutor::class), $c->get(AreaRollbackService::class)));
        $this->container->set(\BusinessMapLocator\Admin\Migration\Action\MigrationPlanningAction::class, static fn (Container $c): \BusinessMapLocator\Admin\Migration\Action\MigrationPlanningAction => new \BusinessMapLocator\Admin\Migration\Action\MigrationPlanningAction($c->get(AreaMigrationService::class), $c->get(\BusinessMapLocator\Admin\Shared\AdminActionResponder::class), $c->get(\BusinessMapLocator\Admin\Request\AdminRequest::class)));
        ...
        $this->container->set(\BusinessMapLocator\Admin\Location\Action\SaveLocationAction::class, static fn (Container $c): \BusinessMapLocator\Admin\Location\Action\SaveLocationAction => new \BusinessMapLocator\Admin\Location\Action\SaveLocationAction(
            $c->get(\BusinessMapLocator\Admin\Location\LocationWriteService::class),
